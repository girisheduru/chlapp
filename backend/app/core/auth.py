...
from app.core.firebase import verify_id_token, is_firebase_ready
...
async def get_current_user(
    ...
    if credentials and credentials.scheme == "Bearer" and credentials.credentials:
        ...
        # Token present but invalid — always 401 when Firebase is ready
    ...
    # No token or Firebase not configured/ready (e.g. firebase_admin not installed)
