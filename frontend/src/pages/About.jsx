...
/**
 * About page: ideology and design behind Habit Lab. Inspired by James Clear's public work (speeches, blogs, podcasts).
 */
    ...
    >
      ...
      <div style={sectionCardStyle}>
        ...
        <p style={{ fontFamily: fonts.body, fontSize: 14, color: colors.textMuted, margin: '0 0 16px 0', lineHeight: 1.5 }}>
          Habit Lab draws on ideas from James Clear’s speeches, blogs, and podcasts. We help you apply identity-based habits, tiny steps, cues, and reflection — so small changes add up to lasting results. This is a personal side project, not for commercial use.
        </p>
